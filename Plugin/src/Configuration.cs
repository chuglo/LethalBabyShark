...
namespace LethalBabyShark.Configuration {
    public class PluginConfig
    {
        ...
        {
            SpawnWeight = cfg.Bind("General", "Spawn weight", 90, // TBH I don't think this actually does anything because the probability is always 20 :thinking:
                "The spawn chance weight for LethalBabyShark, relative to other existing enemies.\n" +
